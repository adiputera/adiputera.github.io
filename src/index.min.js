if("serviceWorker" in navigator){navigator.serviceWorker.register("/sw.js").then(reg=>reg.update()).catch(error=>{console.debug("Service Worker registration failed:",error)})}
...
function updateNotifyUI(){if(typeof Notification==="undefined"||isIos()){notifyButton.textContent="⚠️ Notifications not supported on this browser";notifyButton.disabled=!0;notifyButton.style.cursor="default";return}
