...
const notifyButton=document.getElementById("notify-btn");if(notifyButton){const vapidPublicKey="BDQm2phIYp4W1xoVrwisbYBDp-GbT5_kbBjEYQXtoFnsftS_kr05oXD6yBTr9nYIyAu2p6kgAp4VMm8J01IRLII";function updateNotifyUI(){if(typeof Notification==="undefined"||isIos()){notifyButton.textContent="⚠️ Notifications not supported on this browser";notifyButton.disabled=!0;notifyButton.style.cursor="default";return}
